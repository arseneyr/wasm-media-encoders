...
| `moduleCallback` | `((module: WebAssembly.Module, version: String) => void) \| undefined` | Optionally, a callback that will be called with the compiled WebAssembly module and the module's version. You can cache this module client-side and pass it as the `wasm` parameter to avoid fetching and compiling it every time.                                                                                                                                                                                                                                     |
